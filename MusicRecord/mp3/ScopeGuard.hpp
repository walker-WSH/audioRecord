...
public:
	...
	static void execute(F&& f, T&& t, P&&... p)
	{
...
{
public:
	static ScopeGuard<F, P...>
		MakeScopeGurad(F f, P... p)
	{
...
template<typename F, typename...P>
inline auto MakeGuard(F f, P... p)->ScopeGuard < F, P... >
{
...
{
public:
	static ObjectScopeGuard<O, F, P...>
		MakeObjectScopeGurad(O&& o, F f, P... p)
	{
